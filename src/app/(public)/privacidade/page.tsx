...
export const metadata: Metadata = {
  title: 'Privacidade - AlugaPA',
  description: 'Informações sobre Privacidade no AlugaPA.',
};
    ...
    <div className="bg-slate-50 min-h-screen py-10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="bg-white p-12 rounded-3xl shadow-sm border border-slate-200">
          <h1 className="text-3xl md:text-5xl font-black text-slate-900 mb-6">Privacidade</h1>
